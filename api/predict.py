...
CHANGES IN v3.0.0 (NPK Adaptation):
    - Nitrogen (N) from the 7-in-1 sensor is injected into the 'nitrite' pipeline.
    - N-to-Nitrite scaling implemented to prevent model saturation (Total N >> NO2-).
    - 10 engineered features (log transforms, interactions, polynomial)
    - Labels: Excellent / Good / Poor
    - Nitrite input validation bounded dynamically to 200.0 mg/L for NPK hardware.
"""
